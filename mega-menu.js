...
(function () {
  ...
  var css = [
    ...
    /* panel */
    '.jj-mega{background:var(--jj-panel);color:var(--jj-ink);box-shadow:0 3px 6px rgba(0,0,0,.16),0 3px 6px rgba(0,0,0,.23);overflow:hidden;transform-origin:top center;opacity:0;transform:translateY(-8px);transition:opacity .18s ease,transform .22s ease;pointer-events:none;max-height:0;display:none;}',
    '.jj-mega.jj-open{opacity:1;transform:translateY(0);pointer-events:auto;max-height:1200px;display:block;}',
  ...
  host.innerHTML = [
    ...
    '<div class="jj-mega jj-compact" data-menu="rhino" id="jj-rhino">',
      ...
      '<div class="jj-grid">',
        '<div class="jj-feat">',
          ...
          '<a href="https://www.3jsautobody.com/rhino-lining-quote" class="jj-cta">Get A Quote <span class="jj-arrow"></span></a>',
      ...
      '<div class="jj-foot">',
        '<div class="jj-foot-links">',
          '<a href="https://www.3jsautobody.com/rhino-lining-quote" class="jj-foot-link"><span class="jj-foot-dot"></span> Schedule an install</a>',
    ...
    '<div class="jj-mega jj-bundles" data-menu="bundles" id="jj-bundles">',
      ...
      '<div class="jj-grid">',
        ...
        '<div class="jj-tiles" data-cols="4">',
          '<a href="https://www.3jsautobody.com/bundles" class="jj-tile">',
          ...
          '</a>',
          '<a href="https://www.3jsautobody.com/bundles" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'https://rlsh1855.github.io/3Js-and-RLSH-Website/the%20working%20man%20mega-menu-image.png\');background-size:contain;background-repeat:no-repeat;background-position:center;background-color:#0b1220;"></div>',
          ...
          '</a>',
          '<a href="https://www.3jsautobody.com/bundles" class="jj-tile">',
            '<div class="jj-timg"><div class="jj-tlbl">3 WISE MEN &mdash; STD</div></div>',
          ...
          '</a>',
          '<a href="https://www.3jsautobody.com/bundles" class="jj-tile">',
            '<div class="jj-timg"><div class="jj-tlbl">3 WISE MEN &mdash; PREMIUM</div></div>',
    ...
    '<div class="jj-mega jj-exterior" data-menu="exterior" id="jj-exterior">',
      ...
      '<div class="jj-grid">',
        ...
        '</div>',
        '<div class="jj-tiles" data-cols="3">',
          '<a href="https://rlsh1855.github.io/3Js-and-RLSH-Website/tonneau-covers.html" class="jj-tile">',
            '<div class="jj-timg"><div class="jj-tlbl">TONNEAU COVER</div></div>',
          ...
          '</a>',
          '<a href="https://rlsh1855.github.io/3Js-and-RLSH-Website/bakflip-mx4.html" class="jj-tile">',
            '<div class="jj-timg"><div class="jj-tlbl">BAKFLIP MX4</div></div>',
          ...
          '</a>',
          '<a href="https://rlsh1855.github.io/3Js-and-RLSH-Website/lighting.html" class="jj-tile">',
            '<div class="jj-timg"><div class="jj-tlbl">LED LIGHT BAR</div></div>',
            '<h3>Lighting</h3>',
            '<div class="jj-tbody"><p>LED light bars, pods, fog &amp; halo headlight upgrades — wired clean and weatherproofed.</p></div>',
          '</a>',
          '<a href="https://rlsh1855.github.io/3Js-and-RLSH-Website/steps-running-boards.html" class="jj-tile">',
            '<div class="jj-timg"><div class="jj-tlbl">RUNNING BOARD</div></div>',
            '<h3>Running Boards</h3>',
            '<div class="jj-tbody"><p>Powered, fixed, and oval-step boards for full-size trucks, SUVs &amp; Jeeps.</p></div>',
          '</a>',
          '<a href="https://rlsh1855.github.io/3Js-and-RLSH-Website/floor-liners.html" class="jj-tile">',
            '<div class="jj-timg"><div class="jj-tlbl">FLOOR LINER</div></div>',
            '<h3>Floor Liners &amp; Mats</h3>',
            '<div class="jj-tbody"><p>Custom-cut, all-weather coverage — WeatherTech, Husky &amp; OEM-matched options.</p></div>',
          '</a>',
          '<a href="https://rlsh1855.github.io/3Js-and-RLSH-Website/towing-hitches.html" class="jj-tile">',
            '<div class="jj-timg"><div class="jj-tlbl">TOW HITCH</div></div>',
            '<h3>Towing</h3>',
      ...
      '<div class="jj-foot">',
        '<div class="jj-foot-links">',
          ...
          '<a href="https://rlsh1855.github.io/3Js-and-RLSH-Website/parts-catalog.html" class="jj-foot-link"><span class="jj-foot-dot"></span> Fitment guide</a>',
