(function(){
  ...
  document.body.insertAdjacentHTML('beforeend',
    ...
    '</div>'+
    '<div class="gc-saved" id="gc-saved"><div class="gc-saved-check">&#10003;</div><p class="gc-saved-title">Vehicle Saved!</p><p class="gc-saved-pill" id="gc-saved-pill">&#8212;</p>'+
    '<div class="gc-saved-actions"><a href="https://www.3jsautobody.com/exterior-accessories" class="gc-saved-btn red">Shop Accessories</a><button class="gc-saved-btn out" id="gc-change-btn">Change Vehicle</button></div></div>'+
    '</div></div>'
  );
  ...
  var GC_MAKES={'Ford':['F-150','Super Duty F-250/F-350','Ranger','Maverick'],'Chevrolet':['Silverado 1500','Silverado 2500HD/3500HD','Colorado'],'GMC':['Sierra 1500','Sierra 2500HD/3500HD','Canyon'],'RAM':['1500','2500/3500'],'Toyota':['Tacoma','Tundra'],'Nissan':['Titan','Titan XD','Frontier'],'Honda':['Ridgeline'],'Jeep':['Gladiator']};
  var GC_TRIMS={'F-150':['XL','XLT','Lariat','King Ranch','Platinum','Limited','Raptor','Raptor R'],'Super Duty F-250/F-350':['XL','XLT','Lariat','King Ranch','Platinum','Limited','Tremor'],'Ranger':['XL','XLT','Lariat','Raptor'],'Maverick':['XL','XLT','Lariat'],'Silverado 1500':['WT','Custom','LT','RST','LTZ','High Country','Trail Boss','ZR2'],'Silverado 2500HD/3500HD':['WT','Custom','LT','LTZ','High Country'],'Colorado':['WT','LT','Z71','ZR2','Trail Boss'],'Sierra 1500':['Pro','SLE','Elevation','SLT','AT4','Denali','Denali Ultimate'],'Sierra 2500HD/3500HD':['Pro','SLE','SLT','AT4','Denali'],'Canyon':['Pro','SLE','Elevation','SLT','AT4X','Denali'],'1500':['Tradesman','Big Horn','Lone Star','Laramie','Rebel','TRX','Limited','Longhorn'],'2500/3500':['Tradesman','Big Horn','Laramie','Power Wagon','Limited','Longhorn'],'Tacoma':['SR','SR5','TRD Sport','TRD Off-Road','Limited','TRD Pro','Trailhunter'],'Tundra':['SR','SR5','Limited','Platinum','1794 Edition','TRD Pro','Capstone'],'Titan':['S','SV','Pro-4X','Platinum Reserve'],'Titan XD':['S','SV','Pro-4X','Platinum Reserve'],'Frontier':['S','SV','Pro-4X','PRO-X'],'Ridgeline':['Sport','RTL','RTL-E','Black Edition'],'Gladiator':['Sport','Sport S','Willys','Rubicon','Mojave']};
  var GC_BEDS={'F-150':[["5'6\" Short Bed",66],["6'6\" Standard Bed",78]],'Super Duty F-250/F-350':[["6'9\" Standard Bed",81],["8' Long Bed",96]],'Ranger':[["5' Short Bed",60],["6' Standard Bed",72]],'Maverick':[["4'6\" Compact Bed",54]],'Silverado 1500':[["5'9\" Short Bed",69],["6'7\" Standard Bed",79]],'Silverado 2500HD/3500HD':[["6'7\" Standard Bed",79],["8' Long Bed",96]],'Sierra 1500':[["5'9\" Short Bed",69],["6'7\" Standard Bed",79]],'Sierra 2500HD/3500HD':[["6'7\" Standard Bed",79],["8' Long Bed",96]],'Colorado':[["5'2\" Short Bed",62],["6'7\" Standard Bed",79]],'Canyon':[["5'2\" Short Bed",62],["6'7\" Standard Bed",79]],'1500':[["5'7\" Short Bed",67],["6'4\" Standard Bed",76],["8' Long Bed",96]],'2500/3500':[["6'4\" Standard Bed",76],["8' Long Bed",96]],'Tacoma':[["5' Short Bed",60],["6' Standard Bed",72]],'Tundra':[["5'6\" Short Bed",66],["6'6\" Standard Bed",78],["8' Long Bed",96]],'Titan':[["5'7\" Short Bed",67],["6'7\" Standard Bed",79]],'Titan XD':[["6'7\" Standard Bed",79]],'Frontier':[["5' Short Bed",60],["6' Standard Bed",72]],'Ridgeline':[["5'4\" Bed",64]],'Gladiator':[["5' Bed",60]]};

  var gcColor=GC_COLORS[0], gcPending={};
  ...
  function gcClose(){document.getElementById('gc-ov').classList.remove('open');}
  ...
  document.getElementById('gc-change-btn').addEventListener('click',gcReset);
