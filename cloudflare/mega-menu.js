...
(function () {
  ...
  var css = [
    ...
    /* feature column */
    '.jj-feat{background:#fff;padding:36px 26px 36px;border-right:2px solid var(--jj-red);display:flex;flex-direction:column;gap:18px;}',
    ...
    '.jj-icon-cell{background:#fff;padding:14px 8px 12px;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:9px;text-align:center;}',
    '.jj-icon-cell img{width:88px;height:88px;object-fit:contain;}',
    '.jj-ic-lbl{font-family:"Oswald",sans-serif;font-weight:700;font-size:12px;letter-spacing:.14em;text-transform:uppercase;color:#0b1220;line-height:1.1;}',

    /* tiles */
    '.jj-tiles{padding:36px 28px 36px;display:grid;gap:2px;}',
    ...
    '<div class="jj-mega jj-compact" data-menu="rhino" id="jj-rhino">',
      ...
      '<div class="jj-grid">',
        '<div class="jj-feat">',
          ...
          '<a href="/rhino-lining-quote" class="jj-cta">Get A Quote <span class="jj-arrow"></span></a>',
          '<div class="jj-icon-hdr">Certified Resistant To</div>',
          '<div class="jj-icon-grid">',
            '<div class="jj-icon-cell"><img src="images/icons/rhino-cracking.webp" alt="Resistant to cracking" loading="lazy" width="200" height="200"><div class="jj-ic-lbl">Cracking</div></div>',
            '<div class="jj-icon-cell"><img src="images/icons/rhino-peeling.webp" alt="Resistant to peeling" loading="lazy" width="200" height="200"><div class="jj-ic-lbl">Peeling</div></div>',
            '<div class="jj-icon-cell"><img src="images/icons/rhino-bubbling.webp" alt="Resistant to bubbling" loading="lazy" width="200" height="200"><div class="jj-ic-lbl">Bubbling</div></div>',
            '<div class="jj-icon-cell"><img src="images/icons/rhino-pinholing.webp" alt="Resistant to pinholing" loading="lazy" width="200" height="200"><div class="jj-ic-lbl">Pinholing</div></div>',
          '</div>',
          '<div class="jj-meta"><span class="jj-pip"></span> Same-day installs available</div>',
        '</div>',
        '<div class="jj-tiles" data-cols="1">',
          '<a href="/rhino-lining-quote" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'Bedliner-Jeep_exterior.webp\');background-size:cover;background-position:center;"></div>',
            '<div class="jj-tbody">',
          ...
          '</a>',
          '<a href="/before-after" class="jj-tile">',
      ...
      '<div class="jj-foot">',
        '<div class="jj-foot-links">',
          '<a href="/rhino-lining-quote" class="jj-foot-link"><span class="jj-foot-dot"></span> Schedule an install</a>',
          '<a href="/rhino-liner" class="jj-foot-link"><span class="jj-foot-dot"></span> Color options</a>',
          '<a href="/warranty" class="jj-foot-link"><span class="jj-foot-dot"></span> Warranty info</a>',
        '</div>',
    ...
    '<div class="jj-mega jj-bundles" data-menu="bundles" id="jj-bundles">',
      ...
      '<div class="jj-grid">',
        '<div class="jj-feat">',
          ...
          '<a href="/bundles" class="jj-cta">Compare Bundles <span class="jj-arrow"></span></a>',
          '<div class="jj-meta"><span class="jj-pip"></span> Up to $1,400 off retail</div>',
        '</div>',
        '<div class="jj-tiles" data-cols="4">',
          '<a href="/bundles" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'405%20ESSENTIALS%20METAL%20CARD.png\');background-size:cover;background-position:center;"></div>',
          ...
          '</a>',
          '<a href="/bundles" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'WORKING%20MAN%20METAL%20CARD-1.png\');background-size:cover;background-position:center;"></div>',
          ...
          '</a>',
          '<a href="/bundles" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'3%20WISE%20MEN1%20METAL%20CARD.png\');background-size:cover;background-position:center;"></div>',
          ...
          '</a>',
          '<a href="/bundles" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'3%20WISE%20MEN%20-PREMIUM%20METAL%20CARD.png\');background-size:cover;background-position:center;"></div>',
    ...
    '<div class="jj-mega jj-exterior" data-menu="exterior" id="jj-exterior">',
      ...
      '<div class="jj-grid">',
        '<div class="jj-feat">',
          ...
          '<a href="/exterior-accessories-V2" class="jj-cta">Shop All Categories <span class="jj-arrow"></span></a>',
          '<div class="jj-meta"><span class="jj-pip"></span> Free fitment check on every order</div>',
        '</div>',
        '<div class="jj-tiles" data-cols="4">',
          '<a href="/tonneau-covers" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'Tonneau-covers-page-hero-image.webp\');background-size:cover;background-position:center;"></div>',
          ...
          '</a>',
          '<a href="/bakflip-mx4" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'bak-bakflip-mx4-2016-ford-f150-blue-beach-lifestyle-01.webp\');background-size:cover;background-position:center;"></div>',
          ...
          '</a>',
          '<a href="/bakflip-mx4-ez-lift" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'images/products/bakflip-mx4-ez-lift-hero.webp\');background-size:cover;background-position:center;"></div>',
            '<h3>BAKFlip MX4 EZ-Lift <span class="jj-new">NEW</span></h3>',
            '<div class="jj-tbody"><p>3X easier to lift, one-handed access, and the most secure MX4 ever built.</p></div>',
          '</a>',
          '<a href="/lighting" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'offroad-lighting-hero.webp\');background-size:cover;background-position:center;"></div>',
            '<h3>Lighting</h3>',
            '<div class="jj-tbody"><p>LED light bars, pods, fog &amp; halo headlight upgrades — wired clean and weatherproofed.</p></div>',
          '</a>',
          '<a href="/steps-running-boards" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'go-rhino/rb-running-board-red-truck.webp\');background-size:cover;background-position:center;"></div>',
            '<h3>Running Boards</h3>',
            '<div class="jj-tbody"><p>Powered, fixed, and oval-step boards for full-size trucks, SUVs &amp; Jeeps.</p></div>',
          '</a>',
          '<a href="/floor-liners" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'FLOOR%20LINERS%20IMAGE.webp\');background-size:cover;background-position:center;"></div>',
          ...
          '</a>',
          '<a href="/headache-racks" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'Elevate%20Base%20Truck%20Rack.webp\');background-size:cover;background-position:center;"></div>',
            '<h3>Headache Racks</h3>',
            '<div class="jj-tbody"><p>BackRack open, safety &amp; louvered frames — cab protection for work trucks.</p></div>',
          '</a>',
          '<a href="/parts-catalog?cat=bumpers" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'images/products/hpag/F371192740103.webp\');background-size:cover;background-position:center;"></div>',
            '<h3>Off-Road Bumpers <span class="jj-new">NEW</span></h3>',
            '<div class="jj-tbody"><p>Addictive Desert Designs &amp; DV8 front and rear bumpers — winch-ready and built to take a hit.</p></div>',
          '</a>',
          '<a href="/parts-catalog?cat=roof-racks" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'images/products/hpag/RRJL-01.webp\');background-size:cover;background-position:center;"></div>',
            '<h3>Roof &amp; Chase Racks <span class="jj-new">NEW</span></h3>',
            '<div class="jj-tbody"><p>Platform roof racks, bed racks and chase racks — rated for the trail, built for gear.</p></div>',
          '</a>',
          '<a href="/parts-catalog?cat=rock-sliders" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'images/products/hpag/SRBR-02.webp\');background-size:cover;background-position:center;"></div>',
            '<h3>Rock Sliders &amp; Steps <span class="jj-new">NEW</span></h3>',
            '<div class="jj-tbody"><p>Frame-mounted rocker protection that doubles as a step — for trucks, Jeeps &amp; Broncos.</p></div>',
          '</a>',
          '<a href="/parts-catalog?cat=skid-plates" class="jj-tile">',
            '<div class="jj-timg" style="background-image:url(\'images/products/hpag/SPBR-03.webp\');background-size:cover;background-position:center;"></div>',
            '<h3>Skid Plates &amp; Armor <span class="jj-new">NEW</span></h3>',
            '<div class="jj-tbody"><p>Steel and aluminum underbody armor — protect what you can\'t see until it\'s too late.</p></div>',
          '</a>',
        '</div>',
      '</div>',
      '<div class="jj-foot">',
