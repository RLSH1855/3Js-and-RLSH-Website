      ...
      '<div class="jj-grid">',
        '<div class="jj-feat">',
          ...
          '<div class="jj-icon-grid">',
            '<div class="jj-icon-cell"><img src="Chemical%20Resistant.png" alt="Chemical Resistant"><div class="jj-ic-lbl">Chemical</div></div>',
            '<div class="jj-icon-cell"><img src="Impact%20Resistant.png" alt="Impact Resistant"><div class="jj-ic-lbl">Impact</div></div>',
            '<div class="jj-icon-cell"><img src="Abrasion%20Resistant.png" alt="Abrasion Resistant"><div class="jj-ic-lbl">Abrasion</div></div>',
            '<div class="jj-icon-cell"><img src="SlipResistant.png" alt="Slip Resistant"><div class="jj-ic-lbl">Slip</div></div>',
          '</div>',
